...
@endif
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{url('/admin/service/edit/'.$service->id)}}" class="btn btn-warning">Edit</a></td>
      <td><a href="{{url('/admin/service/delete/'.$service->id)}}" class="btn btn-danger">Delete</a></td>
    </tr>
    @endforeach
  </tbody>
</table>
...
<span class="text-danger">{{$message}}</span>        
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" name="service_text" aria-describedby="emailHelp">
    @error('service_text')
<span class="text-danger">{{$message}}</span>        
    @enderror
  </div>
