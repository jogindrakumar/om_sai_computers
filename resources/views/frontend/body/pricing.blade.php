        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="{{asset('frontend/assets/images/computer.svg')}}" alt="">
                        </div>
                        <div class="pricing-header text-center">
                            <h5 class="sub-title">BUY Computer</h5>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="{{asset('frontend/assets/images/repair.svg')}}" alt="">
                        </div>
                        <div class="pricing-header text-center">
                            <h5 class="sub-title">Repair</h5>
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="{{asset('frontend/assets/images/bulk.svg')}}" alt="">
                        </div>
                        <div class="pricing-header text-center">
                            <h5 class="sub-title">BUY Computer In Bulk</h5>
